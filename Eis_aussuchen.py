...
import easygui
eis = easygui.buttonbox("Was wollen Sie fuer eine Eissorte?", choices = ['Himbeer', 'Erdbeer', 'Kirsch', 'Waldfrucht', 'Heidelbeere', 'Schoko', 'Vanille', 'Mokka', 'Rocher', 'Mango', 'Granatapfel', 'Cranberry', 'Sesam', 'Jne', 'Limmette', 'Karamel mit gesalzener Butter', 'Smarties', 'Casis', 'Orange', 'Mandarine', 'Malaga', 'Schlumpfeis', 'Tutti Frutti', 'Praline', 'Amarena-Kirsch', 'Zitrus-Mix', 'Kafee-eis', 'Papaya', 'Ananas', 'After-Eight', 'Milchschokolade', 'Weisseschokolade', 'Snickerseis', 'Marseis', 'Twixeis', 'Bountyeis'])
